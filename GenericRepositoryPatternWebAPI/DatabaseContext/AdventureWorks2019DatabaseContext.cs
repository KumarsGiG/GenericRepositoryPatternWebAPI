...
namespace GenericRepositoryPatternWebAPI.DatabaseContext
{
    public class AdventureWorks2019DatabaseContext : DbContext
    {
        private readonly IConfiguration _configuration;

        public AdventureWorks2019DatabaseContext(IConfiguration configuration, DbContextOptions<AdventureWorks2019DatabaseContext> options)
            : base(options)
        {
